    ...
    <>
            ...
            items-center justify-between">
                ...
                <div>
                  <div className="lg:w-[570px]">
                    ...
                    Helping people live healthy with certainty,
                    Medicare uses doctor validated intelligent systems to help individuals make better health choices every day.
                    </p>
                    <Link to="/doctors">
        ...
        <section>
          <div className="container">
            <div className="xl:w-[470px] mx-auto">
              ...
              <p className="text__para text-center">
                Here medical services provided by our organization 
              </p>
            </div>
            <ServicesList />
          </div>
        ...
        <section>
          <div className="container">
            <div className="xl:w-[470px] mx-auto">
                  ...
                  <p className="text__para text-center">
                    Here our Great Doctor, Who always ready to care your health.
                  </p>
                </div>
                <DoctorList />
            </div>
          ...
          <div className="container">
            <div className="flex justify-between gap-[50px] lg:gap-0">
              ...
              <div className="w-full md:w-1/2">
                <h2 className="heading">
                  Most questions by our beloved patiens
                </h2>
                <FaqList />
              </div>
            </div>
        ...
        <section>
          ...
          <div className="xl:w-[470px] mx-auto">
                  ...
                  <p className="text__para text-center">
                    Here are the feedback and reviews by our beloved customers.
                  </p>
                </div>
                <Testimonial />
          </div>
